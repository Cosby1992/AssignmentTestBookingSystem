...
class SvcGetBookingsForEmployeeTest extends ContainerizedDbIntegrationTest {
    ...
    public void getBookingsForCustomerMustReturnCorrectBookings() throws SQLException, BookingServiceException {
        ...
        creations.add(new BookingCreation(1, employeeId, Date.valueOf("2000-01-01"), Time.valueOf("01:00:00"), Time.valueOf("11:00:00")));
        creations.add(new BookingCreation(2, employeeId, Date.valueOf("2001-01-01"), Time.valueOf("02:00:00"), Time.valueOf("12:00:00")));
        creations.add(new BookingCreation(3, employeeId, Date.valueOf("2002-01-01"), Time.valueOf("03:00:00"), Time.valueOf("13:00:00")));
        creations.add(new BookingCreation(4, employeeId, Date.valueOf("2003-01-01"), Time.valueOf("04:00:00"), Time.valueOf("14:00:00")));

        for (BookingCreation b : creations) {
            svc.createBooking(b.getCustomerId(), b.getEmployeeId(), b.getDate(), b.getStart(), b.getEnd());
        }

        Collection<Booking> bookingFromDb = svc.getBookingsForEmployee(employeeId);
